...
const ComingSoon = () => {
  return (
    <div
      id="page4"
      className="flex flex-col justify-center items-center gap-20 bg-[url('/images/bg-gradient.jpg')] bg-cover lg:bg-right relative -z-10"
    >
      <div
        id="heading4"
      ...
      <div className="mb-20 flex items-around justify-around flex-wrap w-[80%] lg:w-[70%] gap-10">
        <div
          id="leaderboard"
          className="flex flex-col justify-center items-center gap-6 lg:gap-5 bg-[#26172d] w-[300px] h-[350px] rounded-[40px] hover:scale-110 transition hover:bg-[#360f56]"
        >
          <img
